...
class LyricsExtract:
    ...
    def __init__(
        ...
        genres_path: str = os.path.join(os.path.dirname(__file__), "genres.json"),
    ...
    def _transcribe_chunks(
        ...
        prompts = [self.asr._build_text_prompt(context=context, force_language=force_lang) for _ in wav_chunks] # pylint: disable=protected-access # noqa: SLF001
